package com.keronei.notifierclient.ui.main;
...
import com.keronei.notifierclient.data.service.SyncStatusHelper;
import com.keronei.notifierclient.ui.code_executor.CodeExecutorActivity;
import com.keronei.notifierclient.ui.d2_errors.D2ErrorActivity;
import com.keronei.notifierclient.ui.data_sets.DataSetsActivity;
import com.keronei.notifierclient.ui.data_sets.instances.DataSetInstancesActivity;
import com.keronei.notifierclient.ui.foreign_key_violations.ForeignKeyViolationsActivity;
import com.keronei.notifierclient.ui.programs.ProgramsActivity;
import com.keronei.notifierclient.ui.subscriptions.NotificationSubscriptions;
import com.keronei.notifierclient.ui.tracked_entity_instances.TrackedEntityInstancesActivity;
import com.keronei.notifierclient.ui.tracked_entity_instances.search.TrackedEntityInstanceSearchActivity;
...
import static com.keronei.notifierclient.data.service.LogOutService.logOut;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.navPrograms) {
            ActivityStarter.startActivity(this, ProgramsActivity.getProgramActivityIntent(this), false);
        } else if (id == R.id.navNotificationSubscriptions) {
            ActivityStarter.startActivity(this, NotificationSubscriptions.Companion.getIntent(this), false);
